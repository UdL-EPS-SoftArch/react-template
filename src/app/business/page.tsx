...
export default function CafeteriasPage() {
    ...
    useEffect(() => {
        const loadBusinesses = async () => {
            ...
            const api = new BusinessService(authProvider);
            try {
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-10 gap-4 border-b border-gray-200 dark:border-zinc-800 pb-6">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white flex items-center gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-900 dark:text-white"><path d="M18 8h1a4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 0 0 1-4 4H6a4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg>
                            Cafes
                        </h1>
                        ...
                        >
                            ...
                            <div className="p-6 pb-2">
                                <div className="flex justify-between items-start mb-4">
                                    <div className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold border ${cafe.status === "Open"
                                ...
                                <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm mt-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                                    {cafe.address}
                                </div>
                            </div>
                            ...
                            <div className="mt-4 bg-zinc-50 dark:bg-zinc-900/50 border-t border-gray-100 dark:border-zinc-800 p-4 px-6 flex items-center justify-between">
                                ...
                                <BusinessActions id={cafe.ownerId || ''} ownerId={cafe.ownerId || ''} />
                            </div>
                        </div>
                    ))}
                </div>
